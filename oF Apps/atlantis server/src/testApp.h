...
public:
    ...
    void sendFeedback(string ip, string control, int param);
    ...
    int newPlayer(string pname, string ip);
    ofColor getTeamColor(int teamId);
    void joinGame(int playerId, int control, int state);
